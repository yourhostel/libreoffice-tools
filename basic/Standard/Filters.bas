...
' ==== Фільтр людей, які зараз проживають ====
...
' ==== Функція для правильного відмінювання слова "особа" =====
...
' ==== Функція підрахунку видимих рядків та тих, у кого CheckOut сьогодні ====
...
' ==== Скидання фільтру (видалення умов фільтрації) ====
...
' ==== Повертає діапазон даних для фільтру A4:E(останній рядок) ====
